...
//        var session = "example-tdlight-session2";
        ...
        client.addUpdateHandler(TdApi.UpdateAuthorizationState.class, MainClass::onUpdateAuthorizationState);
